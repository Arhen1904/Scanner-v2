...
document.addEventListener("DOMContentLoaded", () => {
  ...
  imageInput.addEventListener("change", () => {
    ...
    if (file) {
      ...
      showImageThumbnail(file); // NUEVO: mostrar miniatura
    } else {
      analyzeButton.style.display = "none";
      clearButton.style.display = "none";
      document.getElementById("imagePreview").style.display = "none"; // Ocultar miniatura
    }
  });
  ...
  clearButton.addEventListener("click", () => {
    ...
    imagePreview.style.display = "none"; // Ocultar miniatura
    imagePreview.classList.remove("show"); // Eliminar la clase show
  });
...
async function processImage(file) {
  ...
  try {
    ...
    if (response.ok) {
      ...
      const extracted = detectInvoiceData(text);
